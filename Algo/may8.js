...
console.log("Actual:   ", makeFrequencyTable(arr1))
console.log("Expected: ", expected1);
console.log("Actual:   ", makeFrequencyTable(arr2))
console.log("Expected: ", expected2);
console.log("Actual:   ", makeFrequencyTable(arr3))
...
console.log(oddOccurrencesInArray(numsE), "should equal", expectedE);